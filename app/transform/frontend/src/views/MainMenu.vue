<template>
  <div class="main-menu">
    <div class="menu-container">
      <h1>Main Menu</h1>
      <p class="welcome-message">Welcome, {{ firstName }} {{ lastName }}</p>
...
export default {
  ...
  setup() {
    ...
    /**
     * Load menu options for the authenticated user
     */
    ...
    const selectMenuOption = async (optionNumber) => {
      ...
      try {
        ...
        if (error.response?.data?.message) {
          ...
          errorMessage.value = 'No access - Admin Only option...'
...
.menu-option-button:hover:not(:disabled) {
